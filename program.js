...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'program.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'program.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'program.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "program.html.mem" : null;
